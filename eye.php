...
$result = queryMysql("SELECT * FROM google_users WHERE description = 'eye' AND worker='doctor'  AND online='online'");	
...
<body>
    ...
    ?>
<a href="../index.php"><h1 style="margin-top: 3%;"><strong style=" padding: 0 40px; font-size: larger;">Eye & Ear Specialists</strong></h1></a>
