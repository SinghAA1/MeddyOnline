...
//   $dbhost  = 'nribaba.com.mysql';    
//   $dbname  = 'nribaba_com';   
//   $dbuser  = 'nribaba_com';   
//   $dbpass  = 'aPUSTmbb';  

// $dbhost  = 'hackathonmvp.com.mysql';    
//   $dbname  = 'hackathonmvp_com';   
//   $dbuser  = 'hackathonmvp_com';   
//   $dbpass  = '6CR32aAz';  
...
<head>    
    ...
    <!--
    body { 
         background-image: url(https://www.jisc.ac.uk/sites/default/files/wi-fi_for_medical_students.jpg);  
...
//     }
  ...
  if ($connection->connect_error) die($connection->connect_error);
	...
	$result = queryMysql("SELECT * FROM google_users WHERE google_id = '$idd'");
	
	$num    = $result->num_rows;
	if ($num==0)
	{
	    queryMysql("INSERT INTO google_users (google_id, google_name, google_email, google_link, google_picture_link) VALUES ('$user->id','$user->name','$user->email','$user->link','$user->picture')");
	}
         
    queryMysql("UPDATE google_users SET current_patient = '0' WHERE google_id = '$idd'");            
