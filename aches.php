...
$result = queryMysql("SELECT * FROM google_users WHERE description = 'aches' AND worker='doctor'  AND online='online'");
...
<body>
    ...
    ?>
<a href="../index.php"><h1 style="margin-top: 3%;"><strong style="padding: 0 40px; font-size: larger;">Aches & Pains</strong></h1></a>
