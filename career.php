...
$result1 = queryMysql("SELECT * FROM google_users WHERE description = 'career'");	
...
<body>
    ...
    ?>
    <a href="../index.php"><h1 style="margin-top: 3%;"><strong style="background-color: black; color: white; padding: 0 20px;">Alyserve - Career Advice from the best</strong></h1></a>
    <div class="container">
